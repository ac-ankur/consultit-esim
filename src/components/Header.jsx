        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="md:hidden flex items-center">
            ...
            <button
              ...
              className="text-gray-800 hover:text-blue-600 transition p-2"
              ...
              {!user ? (
                ...
                <div className="space-y-3">
                  <Link
                    to="/profile"
                    onClick={() => setShowMobileMenu(false)}
                    className="flex items-center gap-3 px-4 py-3 text-gray-800 font-medium hover:bg-gray-100 rounded-lg transition"
                  >
                  ...
                  <button
                    onClick={handleLogout}
                    className="flex items-center gap-3 w-full text-left px-4 py-3 text-red-600 hover:bg-red-50 font-medium transition rounded-lg"
                  >
