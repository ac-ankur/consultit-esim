...
const VendorList = ({ onEditVendor }) => {
  ...
  const fetchVendors = async () => {
    try {
      ...
      const response = await apiClient('/user/get-all');
    ...
    <div className="max-w-7xl mx-auto p-6">
      <div className="mb-8">
        ...
        <p className="mt-2 text-teal-700 font-semibold">
          Total Registered Customers: {vendors.length}
        </p>
              ...
              <div className="flex-1">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Name: {vendor?.profile?.fullName}</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-gray-700">{vendor?.profile?.email}</span>
                  </div>
                  
                  <div className="flex items-center space-x-3">
                    <Phone className="w-4 h-4 text-gray-400" />
                    <span className="text-gray-700">{vendor?.profile?.mobile}</span>
                  </div>
                  
                  <div className="flex items-center space-x-3">
                    <CreditCard className="w-4 h-4 text-gray-400" />
                    <span className="text-gray-700">Orders: {vendor?.profile?.orders ?? 0}</span>
                  </div>
                </div>
